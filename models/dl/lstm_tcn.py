...
from tensorflow.keras.layers import Conv1D, Dropout, Flatten, Dense, LSTM
...
history = model.fit(X, y, epochs=50, batch_size=64, validation_data=(X_val, y_val), callbacks=[MetricsCallback()])
