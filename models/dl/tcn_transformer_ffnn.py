...
# building the TCN model with Transformer decoder layer
model = Sequential()
model.add(Conv1D(filters=128, kernel_size=3, activation='relu', input_shape=(78, 1)))
model.add(Dropout(0.3)) # TODO: change to 0.1
model.add(Conv1D(filters=64, kernel_size=3, activation='relu'))
model.add(Dropout(0.3))
model.add(Conv1D(filters=64, kernel_size=3, activation='relu'))

# adding the Transformer decoder layer
decoder_layer = TransformerDecoderLayer(num_heads=2, dff=64, d_model=64, rate=0.3)
